...
// 		name          string
// 		body          gin.H
// 		buildStubs    func(store *mockdb.MockStore, fstorage *storage.MockStorage)
...
// 			},
// 			buildStubs: func(store *mockdb.MockStore, fstorage *storage.MockStorage) {
// 				fstorage.EXPECT().PutFile(gomock.Any(), gomock.Any(), gomock.Any(), gomock.Any())
// 				arg := db.CreateUserParams{
// 					Username: user.Username,
// 					FullName: user.FullName,
// 					Email:    user.Email,
